...
You write comprehensive pytest test suites for niquests-cache. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('niquests_cache.commands.module.some_function')
