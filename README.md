...
[![GitHub commits since latest release (by SemVer including pre-releases)](https://img.shields.io/github/commits-since/Tatsh/niquests-cache/v0.2.4/master)](https://github.com/Tatsh/niquests-cache/compare/v0.2.4...master)
...
[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/Tatsh/niquests-cache/master.svg)](https://results.pre-commit.ci/latest/github/Tatsh/niquests-cache/master)
